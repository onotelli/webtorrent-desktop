...
**Go offline (no internet) before running the integration tests.** Otherwise, the torrents will show nonzero progress and the screenshots won't match exactly.
...
* The resulting Github PR will then show, pixel by pixel, the exact UI changes that were made! Se https://github.com/blog/817-behold-image-view-modes
